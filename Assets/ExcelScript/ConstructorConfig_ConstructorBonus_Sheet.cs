...
{
	[Serializable]
	public class ConstructorBonus : EERowData
	{
		[EEKeyField]
		[SerializeField]
		...
		public ConstructorBonus()
		{
		}

#if UNITY_EDITOR
		public ConstructorBonus(List<List<string>> sheet, int row, int column)
		{
	...
	public class ConstructorConfig_ConstructorBonus_Sheet : EERowDataCollection
	{
		[SerializeField]
		private List<ConstructorBonus> elements = new List<ConstructorBonus>();

		public override void AddData(EERowData data)
		{
			elements.Add(data as ConstructorBonus);
		}
