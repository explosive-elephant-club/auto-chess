...
public class ExampleLoadData : MonoBehaviour
{
	...
	private void FindDataExample()
	{
		...
		var multiSheet01 = _eeDataManager.Get<EasyExcelGenerated.MultiSheet02>(1001);
		Debug.Log(multiSheet01.Description);

		// Get EasyExcelGenerated.KeyColumn list
		List<EasyExcelGenerated.MultiSheet01> list = _eeDataManager.GetList<EasyExcelGenerated.MultiSheet01>();
